...
<body>
	...
	<section class="mrg-t-50">
		<div class="container">
			<div class="row">

			
				<div class="col-md-4 col-sm-12 ">
					<div class="blog-wrapper cx-blog-4">
						<div class="img-thumb">
							<a href="#">
								<div class="img-wrapper">
									<img src="images/blog-post.jpg" alt="LET’S MAKE THINGS BETTER." class="img-responsive">
								</div>
							</a>
						...
						<div class="blog-content">
							<a class="read-more" href="#">Wordpress</a>
							<a class="read-more" href="#">php</a>
							<p class="blog-title">
								<a href="#">let'make things better </a>
							</p>
							<div class="blog-info">
								<span>
									<i class="fa fa-clock-o" aria-hidden="true"></i>16-12-16								
								</span>
								<span> 											
									<i class="fa fa-comments"></i><a href="#"> no Comment</a>
								</span>
				...
				<div class="col-md-4 col-sm-12 ">
					<div class="blog-wrapper cx-blog-4">
						...
						<div class="blog-content">
							...
							<a class="read-more" href="#">php</a>
							<p class="blog-title">
								<a href="#">let'make things better let'make things better</a>
							</p>
							<div class="blog-info">
								<span>
									<i class="fa fa-clock-o" aria-hidden="true"></i>16-12-16							
