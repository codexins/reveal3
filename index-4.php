...
<head>
	...
	<link href="https://fonts.googleapis.com/css?family=Open+Sans:400,600,600i|PT+Sans:400,700" rel="stylesheet">
	<!--[if IE]>
...
<body>
	...
	<header class="header fill-screen  layout-4 ">
		...
		<div class="slider-text text-center ">
			...
			<a href="#" class="btn-btn-primary btn-rv layout-4-bg ">know more</a>
			<a href="#" class="btn-btn-primary btn-rv layout-btn2">Buy now </a>
		</div>
	</header>  <!-- end of header -->
	
	<div class="clearfix"></div>
	<section id="story_layout_4" class="mrg-0">
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
					<div class="layout-4-story">
						<div class="story-left">
							<div class=" layout-4-title rv2-title">
								<h2 class="primary-title rv2">OUR STORY </h2>
								<h4 class="secondary-title rv2">For the next generation of big businesses.</h4>
							</div>

							<p>We are creative coders, lorem undergraduate tomato soup, but do occaecat time and vitality, such as labor and obesity. Over the years, I will come, who will nostrud exercise, efforts if the school district, and.At eos tale debitis mediocrem. Nec velit menandri ut, id admodum similique Sit 
							</p>
							<blockquote>
								“ Pro volumus deserunt ne. Mel ut tota fierent definiebas. At eos tale debitis mediocrem. Nec velit menandri ut, id admodum similique Sit purto veniam conclusionemque ne.”
							
							</blockquote>
							<p>ut tota fierent definiebas. At eos tale debitis mediocrem. Nec velit menandri ut, id admodum similique Sit purto veniam  cu aliquam singulis his. No mea duis explicari ius.chool district, and.At eos tale debitis mediocrem. Nec velit menandri ut. </p>
							<div class="signature-image">
								<img src="v4-img/signature.jpg" alt="">
							</div>
						</div>
						<div class="story-right">
							<div class=" featured-layout-4 ">
								...
								<div class="story-featured-content">
									<p>Lorem ipsum dolor sit amet, iuvaret persecuti adversarium ex quo,.</p>
								</div>
							</div>
							<div class=" featured-layout-4 ">
								<div class="featured-title">
	...
	<div class="clearfix"></div>
	<section class="counter-layout-4 mrg-b-50">
		<div class="container">
			<div class="row">
				<div class="col-sm-3 ">
	...
	<div class="clearfix"></div>
	<section class="services mrg-50 layout-4 pad-100">
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
						...
						<div class="service-item rv3 pad-50">
							...
							<div class="content-wrape">
								<div class="service-icon">
									<img src="v4-img/services-icon.jpg" alt="">
								</div>
